        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="/supplier/simpan" method="POST">
                        @csrf
                        <div class="form-group">
                            <label for="exampleInputUsername1">Nama Supplier</label>
                            <input type="text" name="nama_supplier" class="form-control" id="exampleInputUsername1" placeholder="Nama Supplier" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputUsername1">Nama Perusahaan</label>
                            <input type="text" name="nama_perusahaan" class="form-control" id="exampleInputUsername1" placeholder="Nama Perusahaan" required>
                        </div>
                        <div class="form-group">
